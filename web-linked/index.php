      ...
      <div class="container">
        ...
        <div class="row mt-lg--45">
          <div class="col-lg-4 mt--30" data-aos="fade-up" data-aos-duration="800" data-aos-once="true">
            <a href="https://docs.google.com/spreadsheets/d/1CdC9fWhZEye_u0XXtjhD8Ej4B4kfPisz9IeR46WVmV0/edit?usp=sharing" target="_blank" class="service-card--1">
              <h3 class="card-title">Close the Loop</h3>
              <i class="fas fa-chevron-circle-right"></i>
            </a>
          </div>
          <div class="col-lg-4 mt--30" data-aos="fade-up" data-aos-duration="1000" data-aos-once="true" data-aos-delay="200">
            <a href="https://docs.google.com/spreadsheets/d/1h_VFW4YJmNrKXtOibdZkdM0neHdRBgiMx3QDKmO_4bQ/edit?usp=sharing" target="_blank" class="service-card--1">
              <h3 class="card-title">Program HVC</h3>
              <i class="fas fa-chevron-circle-right"></i>
            </a>
          </div>
          <div class="col-lg-4 mt--30" data-aos="fade-up" data-aos-duration="1000" data-aos-once="true" data-aos-delay="400">
            <a href="https://docs.google.com/spreadsheets/d/14zYNNu0ih1rQGH6F0rAUxCUITL7sm_htcURcGqY_Yms/edit?usp=sharing" target="_blank" class="service-card--1">
              <h3 class="card-title">Orbit TR3</h3>
              <i class="fas fa-chevron-circle-right"></i>
            </a>
          </div>
          <div class="col-lg-4 mt--30" data-aos="fade-up" data-aos-duration="1000" data-aos-once="true" data-aos-delay="600">
            <a href="https://docs.google.com/spreadsheets/d/16x1IfBWtrbPTOxkcaGp4W5ROgiG7MoNCC02UjSYhQYw/edit?usp=sharing" target="_blank" class="service-card--1">
              <h3 class="card-title">Rekap Pertanggungan CX Commander</h3>
              <i class="fas fa-chevron-circle-right"></i>
            </a>
          </div>
          <div class="col-lg-4 mt--30" data-aos="fade-up" data-aos-duration="1000" data-aos-once="true" data-aos-delay="800">
            <a href="https://docs.google.com/spreadsheets/d/13joZJKipC1sOA3YMnRhfJw9lChNJAtExYkmLhQNq5WM/edit?usp=sharing" target="_blank" class="service-card--1">
              <h3 class="card-title">Penukaran Poin Plasa TR3</h3>
              <i class="fas fa-chevron-circle-right"></i>
            </a>
          </div>
          <div class="col-lg-4 mt--30" data-aos="fade-up" data-aos-duration="1000" data-aos-once="true" data-aos-delay="200">
            <a href="https://docs.google.com/spreadsheets/d/1YlTrKEKlOqU5ghQvnRqO3dOx2ctyPXxvx-syKapHdFk/edit#gid=849919322" target="_blank" class="service-card--1">
              <h3 class="card-title">Indihome Barakah</h3>
              <i class="fas fa-chevron-circle-right"></i>
            </a>
          </div>
        </div>
