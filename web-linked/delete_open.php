...
$sql = "SELECT nama_button FROM open_link";
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="menu-dropdown dropdown-menu" aria-labelledby="navbarDropdown">
                                <li class="drop-menu-item">
                                    <a class="" href="add_open.php">Baru+</a>
                                </li>
                                <li class="drop-menu-item">
                                    ...
                                    <tbody>
                                        ...
                                        <?php while ($gets = mysqli_fetch_assoc($get)) { ?>
                                            <tr>
                                                ...
                                                <td><a class="delete" data-bs-toggle="modal" data-bs-target="#modal<?=$gets['id']?>" title="Delete" href="deletion_open.php?id=<?= $gets['id'] ?>" data-toggle="tooltip"><i class="material-icons">&#xE872;</i></a></td>
                                            </tr>
                                                ...
                                                <div class="modal-dialog modal-dialog-centered">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            <a class="btn btn-primary" style="text-decoration: none;" href="deletion_open.php?id=<?= $gets['id'] ?>"> Submit</a>
                                                        </div>
                                                        </form>
                                                    </div>
                                                </div>
